      ...
      <>
        <div className="grid gap-1">
          ...
          <Input
            ...
            required
          />
          {isVariableValid(phone) && !isVietnamesePhoneNumberValid(phone) && (
        ...
        <Button
          ...
          disabled={isLoading || !isVietnamesePhoneNumberValid(phone)}
        >
  ...
  return (
    <>
      ...
      <Button
        ...
        disabled={isLoading || !isEmailValidCustom(email)}
      >
        {isLoading && <Loader className="mr-2 h-4 animate-spin" />}
        Login with Email
      </Button>
